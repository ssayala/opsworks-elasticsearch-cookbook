...
cookbook 'apt', '>= 2.6.1', git: 'git://github.com/opscode-cookbooks/apt.git', tag: 'v2.6.1'
...
cookbook 'elasticsearch', '>=0.3.13', git: 'git://github.com/elasticsearch/cookbook-elasticsearch.git', tag: '0.3.13'
